...
> **Status: beta (`0.6.0`).** Kintai is functional and used daily in the demo/reference deployment below, but the API and data schema may still evolve before a stable `1.0.0`. See [CHANGELOG.md](CHANGELOG.md).
