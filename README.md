...
[![Version](https://img.shields.io/badge/version-0.7.6-purple.svg)](CHANGELOG.md)
...
> **Status: beta (`0.7.6`).** Kintai is functional and used daily in the demo/reference deployment below, but the API and data schema may still evolve before a stable `1.0.0`. See [CHANGELOG.md](CHANGELOG.md).
