...
🌐 **English** · [Français](architecture.fr.md) · [日本語](architecture.ja.md)
...
## 🧩 Modular Bundles
Features are split into **Core** (always on) and **Bundles** (`src/Bundles/*/`) — both are part of this AGPL-3.0 repository, nothing is gated behind a separate license.
...
- **Webhooks:** (Planned) Outbound hooks for Slack, LINE, and external HR systems.
