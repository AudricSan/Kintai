...
[![Version](https://img.shields.io/badge/version-0.6.0-purple.svg)](CHANGELOG.fr.md)
...
> **Statut : bêta (`0.6.0`).** Kintai est fonctionnel et utilisé quotidiennement sur l'instance de démonstration ci-dessous, mais l'API et le schéma de données peuvent encore évoluer avant une version stable `1.0.0`. Voir [CHANGELOG.fr.md](CHANGELOG.fr.md).
