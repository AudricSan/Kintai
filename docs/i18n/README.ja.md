...
[![Version](https://img.shields.io/badge/version-0.7.8-purple.svg)](CHANGELOG.ja.md)
...
> **ステータス：ベータ版（`0.7.8`）。** Kintaiは実用段階にあり、下記のデモ環境でも日常的に稼働していますが、安定版 `1.0.0` に至るまでAPIやデータスキーマが変更される可能性があります。詳細は [CHANGELOG.ja.md](CHANGELOG.ja.md) をご覧ください。
