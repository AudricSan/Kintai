...
## 🌟 La philosophie du « SaaS souverain »
Contrairement aux plateformes SaaS traditionnelles qui enferment les données dans une boîte noire, Kintai croit en la **souveraineté des données**. Nos clients ne sont pas de simples « lignes dans une table » ; ils sont propriétaires de leur infrastructure numérique.
- **Isolation physique :** chaque client (propriétaire) possède sa propre base de données isolée.
...
- **Modulaire par conception, ouvert par défaut :** les fonctionnalités avancées (Messagerie, Rapports journaliers, et de futurs ajouts comme la planification assistée par IA) existent sous forme de bundles activables plutôt que d'alourdir le cœur — mais chaque bundle est publié en AGPL-3.0 dans ce dépôt, libre d'auto-hébergement.
