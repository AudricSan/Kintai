...
VALUES
    ('admin@kintai.local',
     ...
     'Super', 'Admin', 'Super Admin', '#6366F1', 1, datetime('now'), datetime('now')),

    ('alice.martin@kintai.local',
     '$2a$12$P8e2BqvyYYA.AB/EwMruVu6mx3SFjWJN2byqy4HVmGnyrRnh6FlLW',
     'Alice', 'Martin', 'Alice Martin', '#10B981', 1, datetime('now'), datetime('now')),

    ('bob.dupont@kintai.local',
     '$2a$12$P8e2BqvyYYA.AB/EwMruVu6mx3SFjWJN2byqy4HVmGnyrRnh6FlLW',
     'Bob', 'Dupont', 'Bob Dupont', '#F59E0B', 1, datetime('now'), datetime('now')),

    ('chloe.tanaka@kintai.local',
     '$2a$12$P8e2BqvyYYA.AB/EwMruVu6mx3SFjWJN2byqy4HVmGnyrRnh6FlLW',
     'Chloé', 'Tanaka', 'Chloé Tanaka', '#EC4899', 1, datetime('now'), datetime('now')),

    ('yuki.yamamoto@kintai.local',
     '$2a$12$P8e2BqvyYYA.AB/EwMruVu6mx3SFjWJN2byqy4HVmGnyrRnh6FlLW',
     'Yuki', 'Yamamoto', 'Yuki Yamamoto', '#8B5CF6', 1, datetime('now'), datetime('now')),

    ('david.leblanc@kintai.local',
     '$2a$12$P8e2BqvyYYA.AB/EwMruVu6mx3SFjWJN2byqy4HVmGnyrRnh6FlLW',
     'David', 'Leblanc', 'David Leblanc', '#0EA5E9', 1, datetime('now'), datetime('now')),

    ('emma.sato@kintai.local',
     '$2a$12$P8e2BqvyYYA.AB/EwMruVu6mx3SFjWJN2byqy4HVmGnyrRnh6FlLW',
     'Emma', 'Sato', 'Emma Sato', '#EF4444', 1, datetime('now'), datetime('now'));
