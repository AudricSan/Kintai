...
<head>
    ...
    <link rel="stylesheet" href="<?= $BASE_URL ?>/assets/css/pdf/payslip-preview.css">
</head>
<body>
...
<div class="ps-page">
        ...
        <div class="ps-info-block">
            ...
            <p>
                ...
                <?php if (!empty($membership['hire_date'])): ?>
                    <?= __('payslip_hire_date') ?> <?= payslip_date($membership['hire_date']) ?>
                <?php endif; ?>
            </p>
        </div>
    </div>
    ...
    <div class="ps-period-banner">
        ...
        <?= __('period_from_to', ['from' => payslip_date($since), 'to' => payslip_date($today)]) ?>
    </div>
    ...
    <div class="ps-summary">
        <div class="ps-summary-box">
            <div class="ps-summary-row">
                ...
                <span><?= payslip_hours($totalGrossMin) ?></span>
            </div>
            <div class="ps-summary-row">
                <span><?= __('payslip_net_hours') ?></span>
                <span><?= payslip_hours($totalNetMin) ?></span>
            </div>
        </div>
    </div>
