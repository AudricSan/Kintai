...
<div class="page-header">
    ...
    <div class="page-header__actions">
        <a href="<?= route_url('employee.shifts.day') ?>" class="btn btn--ghost btn--sm"><svg class="gantt-icon icon-inline" width="16" height="16" viewBox="0 0 24 24"><rect x="4" y="2" width="2" height="20" fill="#555"/><rect x="10" y="6" width="2" height="16" fill="#555"/><rect x="16" y="10" width="2" height="12" fill="#555"/></svg><?= __('gantt_view') ?></a>
        <a href="<?= route_url('employee.shifts.calendar') ?>" class="btn btn--ghost btn--sm">📅 <?= __('calendar_view') ?></a>
        <?php if (feat_bundle('shift-swap')): ?>
